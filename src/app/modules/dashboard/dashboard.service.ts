...
const userDashboardStats = async (userId: string) => {
  ...
  const quotas = [
    {
      name: "Text to Image",
      used: Math.max(0, 20 - user.textToImage),
      limit: 20,
    ...
    {
      name: "AI Chatbot",
      used: Math.max(0, 50 - user.aiChatbot),
      limit: 50,
    ...
    },
    {
      ...
      used: Math.max(0, 10 - user.imageBackgroundRemover),
      limit: 10,
    ...
    },
    {
      ...
      used: Math.max(0, 5 - user.resumeAnalyzer),
      limit: 5,
